        ...
        <DialogContent className="max-w-2xl p-0 overflow-hidden border border-primary/30 bg-card animate-card-entrance" style={{ boxShadow: 'var(--shadow-card-3d)' }}>
          ...
          <div className="relative h-24 overflow-hidden bg-primary flex items-end p-5">
            ...
            <button
              ...
              className="duo-icon-button absolute top-3 right-3 z-20 h-10 w-10 border-white/25 bg-white/10 text-white shadow-[0_4px_0_rgba(255,255,255,0.16)] hover:bg-white/20 hover:text-white hover:shadow-[0_5px_0_rgba(255,255,255,0.16)]"
              aria-label="Fechar"
            >
        ...
        <div className="relative h-24 overflow-hidden bg-muted flex items-end p-5">
          <div className="relative z-10">
            ...
            <button
              ...
              className="duo-icon-button absolute top-3 right-3 z-20 h-10 w-10 border-foreground/20 bg-foreground/10 text-foreground/80 shadow-[0_4px_0_hsl(var(--border))] hover:bg-foreground/20 hover:text-foreground hover:shadow-[0_5px_0_hsl(var(--border))]"
              aria-label="Fechar"
            >
